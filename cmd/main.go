// Command mrtp runs media streaming pipelines.
//
// The subcommand design is taken from [perkeep/cmdmain], but most of the code
// is modified. Subcommands register themselves with [registerSubCmd], using
// the same mechanism as perkeep. See [Perkeep LICENSE] for perkeeps copyright

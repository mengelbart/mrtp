...
func (c *QUICGoConnection) OpenUniStreamSync(ctx context.Context) (roq.SendStream, error) {
...
func (c *QUICGoConnection) AcceptUniStream(ctx context.Context) (roq.ReceiveStream, error) {

...
func (w *WebRTC) Exec(cmd string, args []string) error {
	...
	fs.BoolVar(&pionSCReAM, "pion-scream", false, "Enable pion SCReAM interceptor")
...
`, cmd)
	...
	if pionSCReAM {
		webrtcOptions = append(webrtcOptions, webrtc.EnableSCReAM(750_000, 150_000, flags.MaxTargetRate))
	}

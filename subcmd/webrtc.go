...
func WebRTC(cmd string, args []string) error {
	...
	flags.BoolVar(&wf.pionSCReAM, "pion-scream", false, "Run Pion SCReAM interceptor")
...
`, cmd)
	...
	if wf.pionGCC {
		webrtcOptions = append(webrtcOptions, webrtc.EnableGCC(1_000, 100, 1_000_000))
	}
	if wf.pionSCReAM {
		webrtcOptions = append(webrtcOptions, webrtc.EnableSCReAM(1_000_000, 5_000_000, 1_000_000_000))
	}
	if wf.nada {

...
func Receive(cmd string, args []string) error {
	...
	flags.BoolVar(&rf.gstCCFB, "gst-ccfb", false, "Send CCFB RTCP Feedback packets generated by the screamrx Gstreamer element")
...
`, cmd)
	...
	if rf.roqServer || rf.roqClient {
		...
		if err = receiver.ReceiveRTPStreamFrom(0, rtpSrc, rf.gstCCFB); err != nil {
			return err
		}
		...
		if err = receiver.ReceiveRTPStreamFromGst(0, rtpSrc.GetGstElement(), rf.gstCCFB); err != nil {
			return err
		}
